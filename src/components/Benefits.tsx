          ...
          <div className="inline-block animate-bounce-in" style={{ animationDelay: "0.8s" }}>
            <div className="grid md:grid-cols-3 gap-12 p-12 rounded-3xl bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 border-2 border-primary/20">
              <div className="text-center animate-scale-bounce" style={{ animationDelay: "1s" }}>
                <div className="text-6xl md:text-7xl font-bold text-primary mb-3 animate-pulse-glow">500+</div>
                <div className="text-lg text-foreground font-semibold">Farmers Connected</div>
              </div>
              <div className="text-center animate-scale-bounce" style={{ animationDelay: "1.2s" }}>
                <div className="text-6xl md:text-7xl font-bold text-primary mb-3 animate-pulse-glow">1000+</div>
                <div className="text-lg text-foreground font-semibold">Tons Traded Monthly</div>
              </div>
              <div className="text-center animate-scale-bounce" style={{ animationDelay: "1.4s" }}>
                <div className="text-6xl md:text-7xl font-bold text-primary mb-3 animate-pulse-glow">100%</div>
                <div className="text-lg text-foreground font-semibold">Quality Guarantee</div>
              </div>
            </div>
          </div>
        </div>
